              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12 pt-5">
                    <a class="btn btn-primary" href="../../../index.html"><i class="ti-home me-2"></i>Back to home</a>
                  </div>
                </div>
...
<script src="../../resource/js/codeEditor.js"></script>
<script src="../../resource/js/tabs.js"></script>
<script src="../../resource/js/tooltips.js"></script>
